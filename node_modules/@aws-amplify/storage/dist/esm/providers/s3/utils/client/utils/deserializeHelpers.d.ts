import { ErrorParser, Headers } from '@aws-amplify/core/internals/aws-client-utils';
 ...
 * @internal
 */
export declare const buildStorageServiceError: (error: ParsedError) => ServiceError;
/**
